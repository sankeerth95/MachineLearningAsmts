...
def get_purity(m, e):
	...
	while True:
		...
		if word[0]=="Incorrectly":
			accuracy = 100*(239-float(word[4])-unclustered)/239.0
			break
...
if m==3:
	e = [0.04, 0.05, 0.06, 0.07] #m=3

elif m==6:
	e = [ 0.06, 0.07, 0.08, 0.09]#m=6 

elif m==9:
	e =  [0.06, 0.07, 0.08, 0.09, 0.1, 0.11]
